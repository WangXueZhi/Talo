...
const zhCN = {
  ...
  "settings.reviewPolicy": "记忆保存策略",
  "settings.reviewPolicyDescription": "智能模式会自动保存低风险、证据充分的新记忆；涉及推断、跨项目、已有记忆修改或高影响无依据内容时仍需审核。",
  "settings.reviewPolicy.smart": "智能保存（推荐）",
  "settings.reviewPolicy.manual": "每次都审核",
  ...
  "policy.subtitle": "启动任务规则桥接",
  "policy.summary": "规则摘要",
  "policy.required": "必须执行（每行一项）",
  "policy.forbidden": "禁止行为（每行一项）",
  "policy.topics": "触发主题（每行一项）",
  "policy.save": "保存 Policy",
  "policy.create": "创建 Project Policy",
  "policy.empty": "此项目还没有 Project Policy。创建后可同步到根目录 AGENTS.md。",
  "policy.defaultSummary": "项目启动任务规则",
  "policy.created": "Policy 已创建",
  "policy.saved": "Policy 已保存，等待同步",
  "policy.synced": "AGENTS.md 已同步",
  "policy.sync": "同步",
  "policy.enabled": "Policy 桥接已启用",
  "policy.disabled": "Policy 桥接已禁用",
  "policy.enable": "启用 AGENTS.md 桥接",
  "policy.disable": "禁用桥接",
  "policy.confirmEnable": "确认让 Talo 自动维护项目根目录 AGENTS.md 的受管区块吗？",
  "policy.confirmDisable": "确认禁用 Policy 桥接吗？现有用户文件不会被删除。",
  "policy.summaryRequired": "请输入 Policy 摘要。",
  "policy.edit": "编辑 Policy",
  "policy.collapse": "收起编辑",
  "review.title": "审核中心",
...
const enUS = {
  ...
  "settings.reviewPolicy": "Memory save policy",
  "settings.reviewPolicyDescription": "Smart mode automatically saves low-risk, well-grounded new memories, while inferred, cross-project, existing-memory, or ungrounded high-impact changes still require review.",
  "settings.reviewPolicy.smart": "Smart save (recommended)",
  "settings.reviewPolicy.manual": "Review every time",
  ...
  "policy.title": "Project Policy",
  "policy.subtitle": "Task-start rules bridge",
  "policy.summary": "Summary",
  "policy.required": "Required actions (one per line)",
  "policy.forbidden": "Forbidden actions (one per line)",
  "policy.topics": "Trigger topics (one per line)",
  "policy.save": "Save Policy",
  "policy.create": "Create Project Policy",
  "policy.empty": "This project has no Project Policy yet. Create one to sync it into the root AGENTS.md.",
  "policy.defaultSummary": "Project task-start rules",
  "policy.created": "Policy created",
  "policy.saved": "Policy saved; synchronization is pending",
  "policy.synced": "AGENTS.md synchronized",
  "policy.sync": "Sync",
  "policy.enabled": "Policy bridge enabled",
  "policy.disabled": "Policy bridge disabled",
  "policy.enable": "Enable AGENTS.md bridge",
  "policy.disable": "Disable bridge",
  "policy.confirmEnable": "Enable Talo to maintain the managed block in the project root AGENTS.md?",
  "policy.confirmDisable": "Disable the Policy bridge? Existing user files will not be deleted.",
  "policy.summaryRequired": "Enter a Policy summary.",
  "policy.edit": "Edit Policy",
  "policy.collapse": "Collapse editor",
