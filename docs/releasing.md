...
git tag -a v0.14.5 -m "Talo 0.14.5"
git push origin v0.14.5
```

The tag starts `.github/workflows/release.yml`. It verifies the tag/version match and uploads:

- `talo-agent-skill-0.14.5.zip`
- `talo-codex-plugin-0.14.5.zip`
- `talo-desktop-0.14.5-macos-*.dmg`
- `talo-desktop-0.14.5-macos-*.zip`
- `talo-desktop-0.14.5-windows-x64-setup.exe`
